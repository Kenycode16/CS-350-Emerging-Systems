...
class TemperatureMachine(StateMachine):
    ...
    def processTempStateButton(self):
        ...
        ## 
        self.cycle()  # This will cycle the state machine to the next state
        self.updateLights()  # Update the lights based on the new state 
    ...
    def processTempIncButton(self):
        ...
        self.setPoint += 1
        self.updateLights()  # Update the lights based on the new setpoint
    ...
    def updateLights(self):
        ...
        if(self.current_state.id == "heat"):
            if(temp < self.setPoint):
                ...
                ## Otherwise, turn the red light on solid
                redLight.on()
            ...
            if(temp > self.setPoint):
                ...
                ## Otherwise, turn the blue light on solid
                blueLight.on()
    ##
    ...
    def getFahrenheit(self):
        ...
        # Option 1: Return a default or last known value
            return self.setPoint  # or 72, or any reasonable fallback value
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            lcd_line_1 = f"{current_time.strftime("%Y-%m-%d %H:%M:%S\n")}"
            ...
            if((counter % 30) == 0):
                ##
                ## Send the status update to the TemperatureServer
